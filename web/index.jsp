                        ...
                        <div class="row">
                            <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                                <div class="slider-captions">
                                    <h1 class="slider-title">Best Computer Institute In Lucknow</h1>
            ...
            <div class="item">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                            <div class="slider-captions">
                                <h1 class="slider-title">Computer Learning Course</h1>
            ...
            <div class="item">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                            <div class="slider-captions">
                                <h1 class="slider-title">Best Computer Institute </h1>
                                <p class="slider-text hidden-xs">Phasellus enim libero, blandit vel sapien vitae, condimentum ultricies magna et.</p>
            ...
            <div class="col-md-4">
                <div class="courc-card">
                    ...
                    <div class="cource-det">
                        ...
                        <ul>
                            <li><i class="fas fa-graduation-cap"></i> Adam Jhon <span>5000+Gst</span></li>
                            <li><i class="far fa-calendar-plus"></i> June 24- Nov24</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="courc-card">
                    ...
                    <div class="cource-det">
                        ...
                        <ul>
                            <li><i class="fas fa-graduation-cap"></i> Adam Jhon <span>4000+Gst</span></li>
                            <li><i class="far fa-calendar-plus"></i> June 24- Nov24</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="courc-card">
                    ...
                    <div class="cource-det">
                        ...
                        <ul>
                            <li><i class="fas fa-graduation-cap"></i> Adam Jhon <span>8000+Gst</span></li>
                            <li><i class="far fa-calendar-plus"></i> June 24- Nov24</li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="inner-lay">
            <div class="container">
               <div class="row session-title">
                   <h2>Toranto University in numbers</h2>
        ...
        <div class="instruct-row row">
            <div class="col-md-3">
                <div class="instruct-card">
                    <img src="assets/images/team/en1.jpg" alt="">
                <h6>Maynak Awasthi</h6>
                <p>Java Devloper</p>
